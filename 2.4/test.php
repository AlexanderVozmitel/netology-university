<?php
	...
	{
		if (empty(file_exists(TEST_DIR.$_GET['number'].'.json'))) 
		{
	...
	$test = json_decode(file_get_contents(TEST_DIR.$_GET['number'].'.json'), TRUE);
	...
	if (isset($_POST['submit']))
	{
		...
		exit(GenCertificate($_SESSION['AUTH_USERNAME'], $result));
	}
